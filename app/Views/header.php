...
<html lang="en" >
    ...
    <head>
        ...
        <title>SIG | <?php echo $_SESSION['title']; ?></title>
        ...
        <link rel="shortcut icon" href="<?php echo $GLOBALS['base_url'] ?>assets/img/title.png" /> 
    </head>
    <!-- end::Head -->
				...
				<div class="m-stack__item m-brand  m-brand--skin-dark ">
					<div class="m-stack m-stack--ver m-stack--general">
						<div class="m-stack__item m-stack__item--middle m-brand__logo">
							...
							<img alt="" src="<?php echo $GLOBALS['base_url'] ?>assets/img/header.png"/>
							</a>  
						</div>
			...
			<ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow ">
	            ...
	            " aria-haspopup="true" >
					<a href="<?php echo $GLOBALS['base_url'].'lahan' ?>" class="m-menu__link " >
						...
						<span class="m-menu__link-title">
							<span class="m-menu__link-wrap">      
								<span class="m-menu__link-text">Data Lokasi Lahan</span>
							</span>
						</span>
					</a>
	            </li>
	            ...
	            <li class="m-menu__item  m-menu__item<?php if($_SESSION['title'] == 'Pemetaan Lahan Kosong') echo '--active' ?>
	            " aria-haspopup="true" >
	            ...
	            " aria-haspopup="true" >
					<a href="<?php echo $GLOBALS['base_url'].'user/logout' ?>" class="m-menu__link " >
